        ...
        stage('Pull Docker Image') {
            steps {
                script {
                    ...
                    def containerId = sh(script: 'docker run -d -p 6000:5000 sampleapp', returnStdout: true).trim()
        ...
        stage('Test') {
            steps {
                script {
                    ...
                    def testOutput = sh(script: 'curl http://183.73.144.73:6000', returnStdout: true).trim()
